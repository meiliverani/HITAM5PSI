...
public class TampilSemuaSiswa extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String id = jo.getString(konfigurasi.TAG_STUDENT_ID);
                String name = jo.getString(konfigurasi.TAG_STUDENT_NAME);

                HashMap<String,String> students = new HashMap<>();
                students.put(konfigurasi.TAG_STUDENT_ID,id);
                students.put(konfigurasi.TAG_STUDENT_NAME,name);
                list.add(students);
            }
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{konfigurasi.TAG_STUDENT_ID,konfigurasi.TAG_STUDENT_NAME},
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String studId = map.get(konfigurasi.TAG_STUDENT_ID);
        intent.putExtra(konfigurasi.STUDENT_ID,studId);
